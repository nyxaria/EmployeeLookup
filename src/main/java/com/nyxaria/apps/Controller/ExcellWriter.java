 ...
 * https://stackoverflow.com/questions/23340425/read-data-from-jtable-and-save-it-to-excel-java
 */
...
public class ExcellWriter {
     ...
     * @param sheetName
     */
    public ExcellWriter(ResultSet rs, FormatType[] formatTypes, String sheetName) {
        initPart();
        this.resultSet = rs;
     ...
     * @param sheetName
     */
    public ExcellWriter(JTable tbl, FormatType[] formatTypes, String sheetName) {
        initPart();
        this.tbl = tbl;
        this.formatTypes = formatTypes;
        sheet = workbook.createSheet(sheetName);
     ...
     * @param sheetName
     */
    public ExcellWriter(TableModel tm, FormatType[] formatTypes, String sheetName) {
        initPart();
        this.tm = tm;
        this.formatTypes = formatTypes;
        sheet = workbook.createSheet(sheetName);
